...
function SideBar(){
  ...
  return (
    ...
    <div className='bg-gray-500 py-3 fixed top-40 -left-11 min-w-20 min-h-10 shadow-md items-start rounded-full z-10'>
      ...
      <div className={`${menuLateralAbierto ? "w-80" : "w-0"} bg-gray-600 min-h-screen fixed top-16 left-0 transition-all duration-300`}>
