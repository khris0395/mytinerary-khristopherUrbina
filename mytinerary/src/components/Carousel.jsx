    ...
    return (
        <div className="container mx-auto pt-16 pb-14">
            ...
            <div className="overflow-hidden relative">
                ...
                <button
                    onClick={prevSlide}
                    className=" hidden absolute md:flex items-center justify-center w-12 h-12 top-1/2 left-0 z-10  transform -translate-y-1/2 bg-black text-white p-2 rounded-full"
                >
                ...
                <button
                    onClick={nextSlide}
                    className="hidden absolute md:flex items-center justify-center w-12 h-12 top-1/2 right-0 z-10 transform -translate-y-1/2 bg-black text-white p-2 rounded-full"
                >
                ...
                <div className="container relative">
                    ...
                    >
                        {cityChunks.map((chunk, chunkIndex) => (
                            ...
                            <div key={chunkIndex} className="w-full flex-shrink-0 grid md:grid-cols-2 lg:grid-cols-4 gap-4 ">
